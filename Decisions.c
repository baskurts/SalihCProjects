...
// write code for functions declared in Decisions.

// this function uses the comparison operators 
// and thhe if, if-else, and if-else-if statements
...
void decisions5(void){
    ...
    // prompt user to input number numbers
...
// this function illustrates short circuit evaluatuion
